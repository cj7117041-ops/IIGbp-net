...
from lib1.conv_layer import Conv, BNPReLU
import math
...
class CFPModule(nn.Module):
    ...
    def forward(self, input):
        ...
        inp = self.conv1x1_1(inp)  # 1/4
        
        o1_1 = self.dconv_1_1(inp)  # 1/16
        o1_2 = self.dconv_1_2(o1_1)  # 1/16
        o1_3 = self.dconv_1_3(o1_2)  # 1/8
        
        o2_1 = self.dconv_2_1(inp)
        o2_2 = self.dconv_2_2(o2_1)
        o2_3 = self.dconv_2_3(o2_2)  # 1/8
        
        o3_1 = self.dconv_3_1(inp)
        o3_2 = self.dconv_3_2(o3_1)
        o3_3 = self.dconv_3_3(o3_2)  # 1/8
        
        o4_1 = self.dconv_4_1(inp)
        o4_2 = self.dconv_4_2(o4_1)
        o4_3 = self.dconv_4_3(o4_2)  # 1/8
