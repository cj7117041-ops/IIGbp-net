...
from .dataset1 import SegDataset
...
def get_dataloaders(input_paths, target_paths, boundary_paths, batch_size, if_train=True, boundary=0):
    ...
    if if_train:
        train_dataset = SegDataset(
            ...
            transform_boundary=transform_target,
            hflip=True,
            vflip=True,
            affine=True,
        )
...
#     np.random.seed(int(11)+worker_id)
